...
WebUI.click(findTestObject('APP INVOICE/MY TEAM/btn_span_myteam'))

WebUI.click(findTestObject('APP INVOICE/MY TEAM/btn_delete'))

WebUI.click(findTestObject('APP INVOICE/MY TEAM/btn_confirm_delete'))
