...
WebUI.click(findTestObject('APP INVOICE/CLIENT/Edit_Client/btn_edit_client'))

WebUI.delay(5)

WebUI.acceptAlert()

WebUI.clearText(findTestObject('APP INVOICE/CLIENT/New Client/txt_frist_name'))

WebUI.setText(findTestObject('APP INVOICE/CLIENT/New Client/txt_last_name'), Keys.chord(Keys.DELETE))

//WebUI.clearText(findTestObject('APP INVOICE/CLIENT/New Client/txt_last_name'), FailureHandling.STOP_ON_FAILURE)
